...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(PostAdapter.ViewHolder holder, int i) {
        ...
        if (post.rec != null) {
            holder.mainConent.setBackgroundColor(Color.argb(64, 200, 200, 255));
        ...
        if (post.post.tags.length == 0) {
            ...
            for (String tag : post.post.tags) {
                ...
                v.setText(tag);
                holder.tags.addView(v, 0, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
            }
        }
    }
